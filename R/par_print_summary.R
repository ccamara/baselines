par_print_summary <- function(){
  ...
  print( "par()$usr:" )  
  print( paste( "     x axis range", par()$usr[ 1 ], " > ", par()$usr[2] ) )
  print( paste( "     y axis range", par()$usr[ 3 ], " > ", par()$usr[4] ) )

  print( "par()$fig:" )  
  print( paste( "     x figure region", par()$fig[ 1 ], " > ", par()$fig[2] ) )
  print( paste( "     y figure region", par()$fig[ 3 ], " > ", par()$fig[4] ) )
